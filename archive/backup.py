    ...
    def _call_api(self, option_text: str, initial: bool=False):
        def thread_target():
            ...
            if not initial:
                ...
                prompt+="\n## **Image prompt**: The image prompt should describe every little detail, and depict the scene from the point of view of the played character without showing the charcter itself.\n"
                ...
                prompt+="\nUse up to three words to descirbe the attributes and the environment."
                prompt+="\nAddress the player in the first person only.\n"
